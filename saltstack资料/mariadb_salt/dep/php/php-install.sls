...
php-source-install:
  file.managed:
    ...
    - source: salt://php/file/php-5.6.9.tar.gz
    - user: root
    - group: root
    - mode: 755
...
redis-plugin:
  file.managed:
    ...
    - source: salt://php/file/redis-2.2.7.tgz
    - user: root
    - group: root
    - mode: 755
  cmd.run:
...
memcache-plugin:
  file.managed:
    ...
    - source: salt://php/file/memcache-2.2.7.tgz
    - user: root
    - group: root
    - mode: 755
...
php-ini:
  file.managed:
    ...
    - source: salt://php/file/php.ini-production
    - user: root
    - group: root
    - mode: 644
...
php-fpm:
  file.managed:
    ...
    - source: salt://php/file/php-fpm.conf.default
    - user: root
    - group: root
    - mode: 644
...
php-redis-config:
  file.append:
    ...
    - text:
      - extension=redis.so
    - unless: grep 'memcache.so' /usr/local/php-fastcgi/etc/php.ini
...
php-fastcgi-service:
  file.managed:
    ...
    - source: salt://php/file/init.d.php-fpm
    - user: root
    - group: root
    - mode: 755
  ...
  service.running:
    ...
    - watch:
      - file: php-ini
      - file: php-fpm
      - file: php-redis-config
      - file: php-memcache-config
